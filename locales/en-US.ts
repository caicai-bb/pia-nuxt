export default {
  ...
  mj: {
    ...
    upImg: '<span>Note: Additional image fees may apply<br/>Formats: jpeg, jpg, png, gif, docx</span><p>Supports drag and drop</p>',
  ...
  mjchat: {
    ...
    more3sb: 'Upload up to 3 images at most',
    ...
    imgCInfo: 'Base Image Info:<br/>1. Use your own images as a base for MJ drawing<br/>2. You can use multiple base images, up to 3, each not exceeding 1M in size',
    imgCadd: '+Add',
    del: 'Delete',
